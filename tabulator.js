...
!(function (e, t) {
  ...
  class r extends t {
    ...
    checkDefinition() {
      Object.keys(this.definition).forEach((e) => {
        -1 === r.defaultOptionList.indexOf(e) &&
          console.warn(
    ...
    setWidthActual(e) {
      (isNaN(e) &&
        ...
        this.subscribedExternal("columnWidth") &&
    ...
    getPosition() {
      return (
        this.table.columnManager.getVisibleColumnsByIndex().indexOf(this) + 1
      );
    }
    getParentComponent() {
      ...
      return new Promise((r, l) => {
        if (s > -1) {
          if (
            ...
            !i &&
              a.elVisible(o) &&
              (n = a.elOffset(o).top - a.elOffset(this.elementVertical).top) >
                0 &&
  ...
  class u extends t {
          ...
          (s.forEach((e) => {
            Object.keys(e).forEach((s, o) => {
              ...
              i[s]
                ? !0 !== i[s] &&
                  void 0 !== r &&
                  ((i[s].sorter = this.calculateSorterFromValue(r)),
                  (i[s] = !0))
                : ((n = {
                    field: s,
                    title: s,
    ...
    setColumns(e, t) {
      ...
      ((this.columns = []),
        ...
        this.table.options.rowHeader &&
          ((this.rowHeader = new r(
            !0 === this.table.options.rowHeader
              ? {}
              : this.table.options.rowHeader,
            this,
            !0,
        ...
        this.subscribedExternal("columnsLoaded") &&
  ...
  class p extends t {
    ...
    setHeight(e, t) {
      (this.height != e || t) &&
        ...
        this.setCellHeight(),
        (this.outerHeight = this.element.offsetHeight),
        this.subscribedExternal("rowHeight") &&
    ...
    updateData(e) {
      ...
      return new Promise((o, n) => {
        ...
        const r = [];
        for (let i in e) {
          this.table.columnManager.getColumnsByFieldRoot(i).forEach((e) => {
            let i = this.getCell(e.getField());
            if (i) {
              let s = e.getFieldValue(t);
        ...
        (this.dispatch("row-data-save-after", this),
          r.forEach(([e, t]) => {
            (e.setValueProcessData(t), i && e.cellRendered());
          }),
          i
            ? (this.normalizeHeight(!0),
              this.table.options.rowFormatter &&
  ...
  class g extends h {
    ...
    scrollToRow(e) {
      ...
      this.elementVertical.scrollTop =
        a.elOffset(t).top -
        a.elOffset(this.elementVertical).top +
        this.elementVertical.scrollTop;
    }
    visibleRows(e) {
      return this.rows();
    ...
    _virtualRenderFill(e, t, i) {
      ...
      if (g && a.elVisible(this.elementVertical)) {
        for (
          ...
          for (
            f = [], o = document.createDocumentFragment(), m = 0;
            m < w && this.vDomBottom < g - 1;
          )
          ...
          const e = [];
          (f.forEach((t) => {
            (t.heightInitialized && t.getHeight()) ||
              (t.calcHeight(!0), e.push(t));
          }),
            e.forEach((e) => {
              e.setCellHeight();
            }),
            f.forEach((e) => {
              ((d = e.getHeight() || this.vDomRowHeight),
                v < l ? (u += d) : (h += d),
  ...
  class f extends t {
    ...
    createTableElement() {
      ...
      return (
        ...
        e.setAttribute("role", "rowgroup"),
        e.setAttribute("id", "tabulator-table-body"),
        e
      );
    }
    ...
    getRowFromPosition(e) {
      return this.getDisplayRows().find(
        (t) => "row" === t.type && t.getPosition() === e && t.isDisplayed(),
      );
    }
    scrollToRow(e, t, i) {
  ...
  class w extends t {
    ...
    bindComponents(e, t) {
      ...
      for (let e of i) {
        ...
        i && ((o[e] = i), (r[e] = { target: n, component: i }));
      }
      return (
        (this.previousTargets = r),
  ...
  class x extends t {
    ...
    check(e, t, i) {
      ...
      return (
        ...
        t
          ? ((s = s + ", Please use the %c" + t + "%c option instead"),
            this._warnUser(
              s,
              "font-weight: bold;",
              "font-weight: normal;",
            ...
            i && (this.table.options[t] = this.table.options[e]))
          : this._warnUser(s, "font-weight: bold;", "font-weight: normal;"),
        !1)
      );
    }
    checkMsg(e, t) {
  ...
  class T extends t {
    ...
    lookupProp(e, t, i) {
      var s;
      return this.props[e] && this.props[e][t]
        ? this.props[e][t]
        : (s = this.lookupKey(e, i))
          ? (this.props[e] || (this.props[e] = {}),
            (this.props[e][t] = s[t] || s),
            this.props[e][t])
          : void 0;
    }
    lookupKey(e, t) {
      ...
      return (
        this.deps[e]
          ? (i = this.deps[e])
          : window[e]
            ? ((this.deps[e] = window[e]), (i = this.deps[e]))
            : t || this.error(e),
        i
      );
    }
      ...
      if (t + this.element.offsetHeight > r)
        if (i)
          ...
          if (e > r)
            ...
            let i = t - e;
            (i < 0 && (i = r - e), (this.element.style.top = i + "px"));
          }
        }
    }
    isVisible() {
  ...
  class D extends M {
    ...
    layout(e) {
      var t = this.table.columnManager.columnsByIndex.find(
        (e) =>
          e.definition.variableHeight || "textarea" === e.definition.formatter,
      );
      (this.dispatch("layout-refreshing"),
        D.modes[this.mode].call(
          this,
          this.table.columnManager.columnsByIndex,
          e,
        ),
        t && this.table.rowManager.normalizeHeight(!0),
  ...
  class P extends M {
    ...
    initialize() {
      ((this.langList = a.deepClone(P.langs)),
        ...
        if ("string" == typeof e) {
          if ((i = document.querySelectorAll(e)).length)
            for (var n = 0; n < i.length; n++)
              (s = F.registry.matchElement(i[n])) && o.push(s);
        } else
          ("undefined" != typeof HTMLElement && e instanceof HTMLElement) ||
          e instanceof F
  ...
  class A extends F {
    ...
    static initializeModuleBinder(e) {
      A.modulesRegistered ||
        ((A.modulesRegistered = !0),
        A._registerModules(H, !0),
        e && A._registerModules(e));
    }
    ...
    static _registerModule(e) {
      (Array.isArray(e) || (e = [e]),
        e.forEach((e) => {
          (A._registerModuleBinding(e), A._registerModuleExtensions(e));
        }));
    }
    static _registerModuleBinding(e) {
      e.moduleName
        ? (A.moduleBindings[e.moduleName] = e)
        : console.error(
    ...
    static _registerModuleExtensions(e) {
      ...
      if (e.moduleExtensions)
        for (let e in t) {
          let i = t[e];
          if (A.moduleBindings[e]) for (let t in i) A._extendModule(e, t, i[t]);
          else {
            A.moduleExtensions[e] || (A.moduleExtensions[e] = {});
            for (let t in i)
              (A.moduleExtensions[e][t] || (A.moduleExtensions[e][t] = {}),
                Object.assign(A.moduleExtensions[e][t], i[t]));
          }
        }
    ...
    static _extendModuleFromQueue(e) {
      ...
      if (t) for (let i in t) A._extendModule(e.moduleName, i, t[i]);
    }
    _bindModules() {
      var e = [],
        t = [],
        i = [];
      for (var s in ((this.modules = {}), A.moduleBindings)) {
        let o = A.moduleBindings[s],
          n = new o(this);
        ((this.modules[s] = n),
          o.prototype.moduleCore
            ? this.modulesCore.push(n)
            : o.moduleInitOrder
              ? o.moduleInitOrder < 0
                ? e.push(n)
                : t.push(n)
  ...
  class O extends t {
    ...
    alert(e, t = "msg") {
      if (e) {
        for (
          this.clear(), this.dispatch("alert-show", t), this.type = t;
          this.msgElement.firstChild;
        )
  ...
  class _ extends A {
    ...
    static extendModule() {
      (_.initializeModuleBinder(), _._extendModule(...arguments));
    }
    static registerModule() {
      (_.initializeModuleBinder(), _._registerModule(...arguments));
    }
    constructor(e, t, i) {
      (super(),
        _.initializeModuleBinder(i),
        (this.options = {}),
    ...
    _buildElement() {
      ...
      for (
        t.classList.add("tabulator"),
          ...
          t.setAttribute("aria-owns", "tabulator-table-body");
        t.firstChild;
      )
    ...
    destroy() {
      ...
      (e.classList.remove("tabulator"),
        e.removeAttribute("tabulator-layout"),
    ...
    setMaxHeight(e) {
      ((this.options.maxHeight = isNaN(e) ? e : e + "px"),
        (this.element.style.maxHeight = this.options.maxHeight),
        this.rowManager.initializeRenderer(),
        this.rowManager.redraw(!0));
    }
    setMinHeight(e) {
      ((this.options.minHeight = isNaN(e) ? e : e + "px"),
  ...
  function I(e, t) {
    ...
    if (((t = t || ""), Array.isArray(e)))
      ...
      for (var s in e) i = i.concat(I(e[s], t ? t + "[" + s + "]" : s));
  ...
  function U(e, t) {
    ...
    if (((t = t || ""), Array.isArray(e)))
      ...
      for (var s in e) i = i.concat(U(e[s], t ? t + "[" + s + "]" : s));
    else i.push({ key: t, value: e });
    return i;
  }
  var J = {
  ...
  class X extends M {
    ...
    initialize() {
      ((this.loaderPromise =
        this.table.options.ajaxRequestFunc || X.defaultLoaderPromise),
        (this.urlGenerator =
          this.table.options.ajaxURLGenerator || X.defaultURLGenerator),
  ...
  class $ extends M {
    ...
    setPasteAction(e) {
      switch (typeof e) {
        case "string":
          ((this.pasteAction = $.pasteActions[e]),
            this.pasteAction ||
    ...
    setPasteParser(e) {
      switch (typeof e) {
        case "string":
          ((this.pasteParser = $.pasteParsers[e]),
            this.pasteParser ||
    ...
    checkPasteOrigin(e) {
      var t = !0;
      return (
        (!this.confirm("clipboard-paste", [e]) &&
          ["DIV", "SPAN"].includes(e.target.tagName)) ||
          (t = !1),
        t
      );
    }
  ...
  class ee extends M {
    ...
    initializeColumn(e) {
      ...
      if (t.topCalc) {
        switch (typeof t.topCalc) {
          case "string":
            ee.calculations[t.topCalc]
              ? (i.topCalc = ee.calculations[t.topCalc])
              : console.warn(
      ...
      if (t.bottomCalc) {
        switch (typeof t.bottomCalc) {
          case "string":
            ee.calculations[t.bottomCalc]
              ? (i.botCalc = ee.calculations[t.bottomCalc])
              : console.warn(
                  "Column Calc Error - No such calculation found, ignoring: ",
                  t.bottomCalc,
                );
    ...
    initializeTopRow() {
      ...
      this.topInitialized ||
        ...
        this.table.columnManager
          .getContentsElement()
          .insertBefore(e, this.table.columnManager.headersElement.nextSibling),
        ...
        e.forEach((e) => {
          (t.push(e.getData()),
            i &&
              ...
              this.rowsToData(s.getFilteredTreeChildren(e)).forEach((e) => {
                t.push(e);
              }));
        }),
        t
    ...
    generateRow(e, t) {
      ...
      return (
        ...
        (i.component = !1),
        (i.getComponent = () => (
          i.component || (i.component = new Q(i)),
          i.component
        )),
        (i.generateCells = () => {
          var t = [];
            ...
            (this.genColumn.setField(s.getField()),
              ...
              this.table.modExists("format")
                ? (this.genColumn.modules.format = {
                    formatter: this.table.modules.format.lookupFormatter(
                      s.definition[e + "CalcFormatter"],
                    ),
                ...
                : (this.genColumn.modules.format = {
                    formatter:
                      this.table.modules.format.lookupFormatter("plaintext"),
                    params: {},
                  }),
  ...
  var te = {
    ...
    xlsx: function (e, i, s) {
      ...
      if (
        ((h.type = "binary"), (r.SheetNames = []), (r.Sheets = {}), i.sheetOnly)
      )
        s(d());
      else {
        if (i.sheets)
  ...
  function se(e, t) {
    ...
    (e.addEventListener("keydown", (t) => {
      var r = e.value.length,
        a = t.key;
      if (1 === t.key.length && !t.ctrlKey && !t.metaKey) {
      ...
      e.addEventListener("keyup", (i) => {
        1 === i.key.length && t.maskAutoFill && r(e.value.length);
      }),
  ...
  let oe = class {
    ...
    _createInputElement() {
      ...
      return (
        this.params.mask && se(t, this.params),
  ...
  var ne = {
    ...
    datetime: function (e, t, i, s, o) {
      var n,
        ...
        a = o.verticalNavigation || "editor",
        l = r
          ? this.table.dependencyRegistry.lookup(
              ["luxon", "DateTime"],
              "DateTime",
            )
          : null,
        ...
        for (let e in o.elementAttributes)
          "+" == e.charAt(0)
            ? ((e = e.slice(1)),
              m.setAttribute(
                e,
                m.getAttribute(e) + o.elementAttributes["+" + e],
              ))
    ...
    tickCross: function (e, t, i, s, o) {
      ...
      return (
        ...
        r.addEventListener("keydown", function (e) {
          ("Enter" == e.key && i(u()), "Escape" == e.key && s());
        }),
        r
      );
    },
    adaptable: function (e, t, i, s, o) {
      ...
      return (
        ...
        o.paramsLookup &&
          (r =
            "function" == typeof o.paramsLookup
              ? o.paramsLookup(n, e)
              : o.paramsLookup[n]),
  ...
  class re extends M {
    ...
    constructor(e) {
      (super(e),
        ...
        this.registerTableOption(
          ...
          this.emptyValueCheck.bind(this),
        ),
    ...
    initialize() {
      (this.subscribe("cell-init", this.bindEditor.bind(this)),
        ...
        this.confirm("edit-nav-disabled") ||
          (this.subscribe(
            "keybinding-nav-prev",
        ...
        Object.keys(this.table.options).includes("editorEmptyValue") &&
          (this.convertEmptyValues = !0));
    }
    pasteBlocker(e) {
    ...
    initializeColumn(e) {
      ...
      ((i.editor = this.lookupEditor(e.definition.editor, e)),
    ...
    lookupEditor(e, t) {
      ...
      switch (typeof e) {
        case "string":
          this.editors[e]
            ? (i = this.editors[e])
            : console.warn("Editor Error - No such editor found: ", e);
          break;
        case "function":
          i = e;
          break;
        case "boolean":
          !0 === e &&
            ("function" != typeof t.definition.formatter
              ? (i = this.editors[t.definition.formatter]
    ...
    cancelEditEvent() {
      return !!this.currentCell && (this.cancelEdit(), !0);
    }
    clearEditor(e) {
      var t,
        i = this.currentCell;
          ...
          "dblclick" === this.options("editTriggerEvent") &&
            i.addEventListener("dblclick", function (s) {
              i.classList.contains("tabulator-editing") ||
                (i.focus({ preventScroll: !0 }), t.edit(e, s, !1));
            }),
          ("focus" !== this.options("editTriggerEvent") &&
            "click" !== this.options("editTriggerEvent")) ||
    ...
    transformEmptyValues(e, t) {
      ...
      return (
        (s.convertEmptyValues || this.convertEmptyValues) &&
          (i =
            s.editorEmptyValueFunc || this.options("editorEmptyValueFunc")) &&
          i(e) &&
          (e = s.convertEmptyValues
            ? s.editorEmptyValue
            : this.options("editorEmptyValue")),
        e
      );
    }
    blur(e) {
  ...
  class ce extends M {
    ...
    generateExportList(e, t, i, s) {
      ...
      return (
        ...
        (a = ce.columnLookups[i]) &&
          (r = (r = a.call(this.table)).filter((e) => this.columnVisCheck(e))),
        (o =
          !1 !== this.config.columnHeaders
            ? this.headersToExportRows(this.generateColumnGroupHeaders(r))
            : []),
    ...
    rowLookup(e) {
      ...
      return (
        "function" == typeof e
          ...
          : ((t = ce.rowLookups[e] || ce.rowLookups.active),
            (i = t.call(this.table))),
        Object.assign([], i)
      );
    }
    ...
    processColumnGroup(e) {
      var t = e.columns,
        ...
        s = {
          title:
            e.definition["title" + this.colVisPropAttach] || e.definition.title,
          column: e,
          depth: 1,
        };
      if (t.length) {
    ...
    columnVisCheck(e) {
      ...
      return (
        (!1 !== this.config.rowHeaders || !e.isRowHeader) &&
        ...
        t.forEach((e) => {
          ...
          (e.forEach((e) => {
            if (e) {
              ...
              t.push(
                new le(i, e.column.getComponent(), e.width, e.height, e.depth),
              );
            } else t.push(null);
          }),
      ...
      return (
        ...
        (e = e.filter((e) => {
          ...
          switch (e.type) {
            case "group":
              ((r = e.level),
                n.push(new le(e.key, e.getComponent(), t.length, 1)));
              break;
            case "calc":
            case "row":
              (t.forEach((e) => {
    ...
    generateTableElement(e) {
      ...
      return (
        ...
        (r.groupHeader =
          this.table.options["groupHeader" + this.colVisPropAttach]),
        r.groupHeader &&
      ...
      return (
        this.cloneTableStyle &&
          ...
          e.firstRow &&
            ...
            (e.styleRowHeader = e.firstRow.getElementsByClassName(
        ...
        e.columns.forEach((e) => {
          if (e) {
            ...
            ((t.colSpan = e.width),
              ...
              e.component._column.parent && e.component._column.parent.isGroup
                ? this.mapElementStyles(
      ...
      if (
        ...
        e.columns.forEach((o, n) => {
          if (o) {
            ...
            if (
              ((h.definition.cssClass
                ? h.definition.cssClass.split(" ")
                : []
              ).forEach(function (e) {
                l.classList.add(e);
              }),
              ...
              u = this.table.modules.format.formatExportValue(
                m,
                this.colVisProp,
              );
            else
            ...
            (u instanceof Node ? l.appendChild(u) : (l.innerHTML = u),
              ...
              h.isRowHeader
                ? ((r = i.styleRowHeader), a.push("background-color"))
                : (r =
                    i.styleCells && i.styleCells[c]
                      ? i.styleCells[c]
                      : i.firstCell),
              r &&
                (this.mapElementStyles(r, l, a),
                h.definition.align && (l.style.textAlign = h.definition.align)),
              this.table.options.dataTree &&
                !1 !== this.config.dataTree &&
                ((t.treeElementField && t.treeElementField == h.field) ||
              ...
              s.appendChild(l),
              m.modules.format &&
                m.modules.format.renderedCallback &&
                m.modules.format.renderedCallback());
          }
        }),
  ...
  var ue = {
    ...
    smart: function (e, t, i, s) {
      const o = e.trim();
      if ("." === o) return !(null === t || "" == t);
      if ("!" === o) return null === t || "" == t;
      if (0 === o.indexOf("<="))
        return this["<="](parseFloat(o.substring(2)), t, i, s);
      if (0 === o.indexOf(">="))
        return this[">="](parseFloat(o.substring(2)), t, i, s);
      if (0 === o.indexOf("<"))
        return this["<"](parseFloat(o.substring(1)), t, i, s);
      if (0 === o.indexOf(">"))
        return this[">"](parseFloat(o.substring(1)), t, i, s);
      if (0 === o.indexOf("="))
        return this["="](o.substring(1).trim(), t, i, s);
      if (o.includes(" ")) {
        const e = o.split(/\s+/).filter((e) => e.length > 0);
        if (e.length > 1) {
          const o = e.join(" AND ");
          return this.smarter(o, t, i, s);
        }
      }
      return this.like(o, t, i, s);
    },
    smarter: function (e, t, i, s) {
      const o = e.trim();
      if (!o) return !0;
      const n = o.split(/\s+(AND|OR)\s+/i);
      if (1 === n.length) return this.smart(o, t, i, s);
      let r = null,
        a = null;
                    ...
                    ? ((r = e.definition.headerFilterFunc),
                      (o = function (i) {
                        ...
                        return (
                          ...
                          me.filters[e.definition.headerFilterFunc](t, o, i, s)
                        );
                      }))
                    : console.warn(
  ...
  var pe = {
      ...
      var s = e.getValue(),
        ...
        l =
          void 0 !== t.tickElement
            ? t.tickElement
            : '<svg enable-background="new 0 0 24 24" height="14" width="14" viewBox="0 0 24 24" xml:space="preserve" ><path class="tabulator-tick" clip-rule="evenodd" d="M21.652,3.211c-0.293-0.295-0.77-0.295-1.061,0L9.41,14.34  c-0.293,0.297-0.771,0.297-1.062,0L3.449,9.351C3.304,9.203,3.114,9.13,2.923,9.129C2.73,9.128,2.534,9.201,2.387,9.351  l-2.165,1.946C0.078,11.445,0,11.63,0,11.823c0,0.194,0.078,0.397,0.223,0.544l4.94,5.184c0.292,0.296,0.771,0.776,1.062,1.07  l2.124,2.141c0.292,0.293,0.769,0.293,1.062,0l14.366-14.34c0.293-0.294,0.293-0.777,0-1.071L21.652,3.211z" fill-rule="evenodd"/></svg>',
        h =
          void 0 !== t.crossElement
            ? t.crossElement
            : '<svg enable-background="new 0 0 24 24" height="14" width="14"  viewBox="0 0 24 24" xml:space="preserve" ><path class="tabulator-cross" d="M22.245,4.015c0.313,0.313,0.313,0.826,0,1.139l-6.276,6.27c-0.313,0.312-0.313,0.826,0,1.14l6.273,6.272  c0.313,0.313,0.313,0.826,0,1.14l-2.285,2.277c-0.314,0.312-0.828,0.312-1.142,0l-6.271-6.271c-0.313-0.313-0.828-0.313-1.141,0  l-6.276,6.267c-0.313,0.313-0.828,0.313-1.141,0l-2.282-2.28c-0.313-0.313-0.313-0.826,0-1.14l6.278-6.269  c0.313-0.312,0.313-0.826,0-1.14L1.709,5.147c-0.314-0.313-0.314-0.827,0-1.14l2.284-2.278C4.308,1.417,4.821,1.417,5.135,1.73  L11.405,8c0.314,0.314,0.828,0.314,1.141,0.001l6.276-6.267c0.312-0.312,0.826-0.312,1.141,0L22.245,4.015z"/></svg>';
    ...
    datetime: function (e, t, i) {
      var s,
        o = this.table.dependencyRegistry.lookup(
          ["luxon", "DateTime"],
          "DateTime",
        ),
    ...
    star: function (e, t, i) {
      ...
      ((r.style.verticalAlign = "middle"),
        ...
        (s = s && !Number.isNaN(s) ? parseInt(s) : 0),
    ...
    traffic: function (e, t, i) {
      var s,
        ...
        d = "#666666";
      if (!Number.isNaN(n) && void 0 !== e.getValue()) {
        switch (
    ...
    toggle: function (e, t, i) {
      ...
      return (
        ...
        d
          ? (s.classList.add("tabulator-toggle-on"),
            (s.style.flexDirection = "row-reverse"),
            t.onColor && (s.style.background = t.onColor))
          : t.offColor && (s.style.background = t.offColor),
    ...
    rownum: function (e, t, i) {
      ...
      return (
        o.watchPosition((e) => {
          (t.relativeToPage &&
            (e +=
              n.modules.page.getPageSize() * (n.modules.page.getPage() - 1)),
            (s.innerText = e));
        }),
        s
      );
    ...
    adaptable: function (e, t, i) {
      ...
      return (
        ...
        t.paramsLookup &&
          (o =
            "function" == typeof t.paramsLookup
              ? t.paramsLookup(s, e)
              : t.paramsLookup[s]),
        ...
        t.valueMap &&
          (s =
            "string" == typeof t.valueMap
              ? function (e) {
                  return e.map((e) =>
                    a.retrieveNestedData(
                      r.options.nestedFieldSeparator,
                      t.valueMap,
                      e,
                    ),
                  );
    ...
    json: function (e, t, i) {
      var s = t.indent || "\t",
        ...
        r = e.getValue();
      return (
        o && (e.getElement().style.whiteSpace = "pre-wrap"),
        JSON.stringify(r, n, s)
      );
    },
  };
  class ge extends M {
    ...
    initializeColumn(e) {
      ((e.modules.format = this.lookupTypeFormatter(e, "")),
        void 0 !== e.definition.formatterPrint &&
          (e.modules.format.print = this.lookupTypeFormatter(e, "Print")),
        void 0 !== e.definition.formatterClipboard &&
          (e.modules.format.clipboard = this.lookupTypeFormatter(
            e,
            "Clipboard",
          )),
        void 0 !== e.definition.formatterHtmlOutput &&
          (e.modules.format.htmlOutput = this.lookupTypeFormatter(
            e,
            "HtmlOutput",
          )));
    }
  ...
  class fe {
    ...
    getComponent() {
      return (
        this.component || (this.component = new be(this)),
        this.component
      );
    }
  }
  ...
  class Re extends M {
    ...
    lookupImporter(e) {
      ...
      return (
        ...
        (t = "string" == typeof e ? Re.importers[e] : e) ||
      ...
      return new Promise((i, s) => {
        ...
        ((o.type = "file"),
          ...
          o.addEventListener("change", (e) => {
            ...
            if (!0 === a) {
              switch (
                (this.dispatch("import-importing", o.files),
    ...
    transformHeader(e) {
      ...
      return this.table.options.importHeaderTransform
        ? (e.forEach((i) => {
            t.push(
              this.table.options.importHeaderTransform.call(this.table, i, e),
            );
          }),
          t)
        : e;
    ...
    transformData(e) {
      ...
      return this.table.options.importValueTransform
        ? (e.forEach((i) => {
            t.push(
              this.table.options.importValueTransform.call(this.table, i, e),
            );
          }),
          t)
        : e;
    ...
    validateFile(e) {
      return (
        !this.table.options.importFileValidator ||
        this.table.options.importFileValidator.call(this.table, e)
      );
    }
    validateData(e) {
      var t;
      return this.table.options.importDataValidator
        ? !0 ===
          (t = this.table.options.importDataValidator.call(this.table, e))
          ? e
          : Promise.reject(t)
        : e;
    }
    setData(e) {
      return (
        this.dispatch("import-imported", e),
  ...
  class ke extends M {
    ...
    getKeyCode(e) {
      if (1 === e.key.length) return e.key.toUpperCase().charCodeAt(0);
      return (
        {
          Enter: 13,
          Escape: 27,
    ...
    initializeRow(e) {
      ...
      ((s.mouseup = function (t) {
        ...
        (s.mousemove = function (t) {
          var s = e.getElement();
          t.pageY - a.elOffset(s).top + i.table.rowManager.element.scrollTop >
          e.getHeight() / 2
  ...
  class He extends M {
    ...
    initializePageCounter() {
      var e = this.table.options.paginationCounter,
        t = null;
      e &&
        ((t = "function" == typeof e ? e : He.pageCounters[e])
          ? ((this.pageCounter = t),
    ...
    _parseRemoteData(e) {
      ...
      if (
        ...
        if (
          this.page > this.max &&
          (console.warn(
            "Remote Pagination Error - Server returned last page value lower than the current page",
          ),
          (i = this.options("paginationOutOfRange")))
        )
          return this.setPage(
            "function" == typeof i ? i.call(this, this.page, this.max) : i,
          );
        this.dispatchExternal("pageLoaded", this.getPage());
      } else
        console.warn(
            ...
            if (
              ...
              n instanceof m
                ? (s.addEventListener("change", (e) => {
                    "click" === this.table.options.selectableRowsRangeMode && o
                      ? (o = !1)
                      : n.toggleSelect();
                  }),
  ...
  class Ve {
      ...
      return (
        ...
        new Proxy(this, {
          get: function (e, t, i) {
            return void 0 !== e[t]
              ? e[t]
              : e._range.table.componentFunctionBinder.handle(
                  "range",
                  e._range,
                  t,
                );
    ...
    setBounds(e, t) {
      this._range.destroyedGuard("setBounds") &&
        this._range.setBounds(e ? e._cell : e, t ? t._cell : t);
    }
    setStartBound(e) {
      this._range.destroyedGuard("setStartBound") &&
        (this._range.setEndBound(e ? e._cell : e),
        this._range.rangeManager.layoutElement());
    }
    setEndBound(e) {
      this._range.destroyedGuard("setEndBound") &&
        (this._range.setEndBound(e ? e._cell : e),
        this._range.rangeManager.layoutElement());
    }
    clearValues() {
  ...
  class Ne extends t {
    ...
    setStart(e, t) {
      (this.start.row === e && this.start.col === t) ||
        ((this.start.row = e),
        (this.start.col = t),
    ...
    setStartBound(e) {
      var t, i;
      "column" === e.type
        ? this.rangeManager.columnSelection &&
          this.setStart(0, e.getPosition() - 1)
        : ((t = e.row.position - 1),
          (i = e.column.getPosition() - 1),
          e.column === this.rangeManager.rowHeader
            ? this.setStart(t, 1)
            : this.setStart(t, i));
    }
    setEndBound(e) {
      ...
      "column" === e.type
        ? this.rangeManager.columnSelection &&
          ("column" === this.rangeManager.selecting
            ? this.setEnd(o - 1, e.getPosition() - 1)
            : "cell" === this.rangeManager.selecting &&
              this.setEnd(0, e.getPosition() - 1))
        : ((t = e.row.position - 1),
          (i = e.column.getPosition() - 1),
          (s = e.column === this.rangeManager.rowHeader),
          "row" === this.rangeManager.selecting
            ? this.setEnd(t, this._getTableColumns().length - 1)
            : "row" !== this.rangeManager.selecting && s
              ? this.setEnd(t, 0)
              : "column" === this.rangeManager.selecting
                ? this.setEnd(o - 1, i)
                : this.setEnd(t, i));
        ...
        this.overlaps(u, d, m, c) &&
          ...
          this.table.rtl
            ? ((this.element.style.right =
                l.offsetWidth - r.offsetLeft - r.offsetWidth + "px"),
              (this.element.style.width =
                r.offsetLeft + r.offsetWidth - a.offsetLeft + "px"))
            : ((this.element.style.left = l.offsetLeft + r.offsetLeft + "px"),
              (this.element.style.width =
                a.offsetLeft + a.offsetWidth - r.offsetLeft + "px")),
          (this.element.style.top = l.offsetTop + "px"),
          (this.element.style.height =
            h.offsetTop + h.offsetHeight - l.offsetTop + "px")));
    }
    atTopLeft(e) {
      return (
        e.row.position - 1 === this.top &&
        e.column.getPosition() - 1 === this.left
      );
    }
    atBottomRight(e) {
      return (
        e.row.position - 1 === this.bottom &&
        e.column.getPosition() - 1 === this.right
      );
    }
    occupies(e) {
    ...
    occupiesColumn(e) {
      return (
        this.left <= e.getPosition() - 1 && e.getPosition() - 1 <= this.right
      );
    }
    overlaps(e, t, i, s) {
      return !(
    ...
    getBounds(e) {
      ...
      return (
        t.length
          ? ((i.start = t[0]), (i.end = t[t.length - 1]))
    ...
    getComponent() {
      return (
        this.component || (this.component = new Ve(this)),
        this.component
      );
    }
    destroy(e) {
        ...
        range: function (e) {
          ...
          return (
            ...
            a &&
              ...
              t.start === t.end && (l = !0),
              i &&
                ((s = (r = this.table.rowManager.activeRows.slice()).indexOf(
                  i.row,
                )),
          ...
          return (
            !!(
              ...
              i &&
                ...
                r.length &&
                  (n = (o =
                    this.table.columnManager.getVisibleColumnsByIndex()).indexOf(
                    i.column,
                  )) > -1))
            ) &&
    ...
    export: {
      columnLookups: {
        range: function () {
          ...
          return (
            this.columnManager.rowHeader &&
              e.unshift(this.columnManager.rowHeader),
            e
          );
        },
      },
  ...
  function We(e, t, i, s, o, n, r) {
    var a = this.table.dependencyRegistry.lookup(
        ["luxon", "DateTime"],
        "DateTime",
      ),
          ...
          (l =
            "string" == typeof r.valueMap
              ? function (e) {
                  return e.map((e) =>
                    a.retrieveNestedData(
                      u.options.nestedFieldSeparator,
                      r.valueMap,
                      e,
                    ),
                  );
  ...
  class Ge extends M {
    ...
    initializeColumn(e) {
      ...
      switch (typeof e.definition.sorter) {
        case "string":
          Ge.sorters[e.definition.sorter]
            ? (s = Ge.sorters[e.definition.sorter])
            : console.warn(
    ...
    sort(e, t) {
      var i = this,
        s = this.table.options.sortOrderReverse
          ? i.sortList.slice().reverse()
          : i.sortList,
        o = [],
        n = [];
      return (
        this.subscribedExternal("dataSorting") &&
          this.dispatchExternal("dataSorting", i.getSort()),
        t || i.clearColumnHeaders(),
        "remote" !== this.table.options.sortMode
          ? (s.forEach(function (e, s) {
              var n;
              e.column &&
                ((n = e.column.modules.sort) &&
                  (n.sorter || (n.sorter = i.findSorter(e.column)),
                  (e.params =
  ...
  class Ue {
    ...
    incrementChar(e) {
      ...
      t
        ? "Z" !== t
          ? (this.columnString[e] = String.fromCharCode(
              this.columnString[e].charCodeAt(0) + 1,
            ))
          : ((this.columnString[e] = "A"),
            e ? this.incrementChar(e - 1) : this.columnString.push("A"))
      ...
      return (
        ...
        new Proxy(this, {
          get: function (e, t, i) {
            return void 0 !== e[t]
              ? e[t]
              : e._sheet.table.componentFunctionBinder.handle(
                  "sheet",
                  e._sheet,
                  t,
                );
  ...
  class Xe extends t {
    constructor(e, t) {
      (super(e.table),
        ...
        (this.columnDefinition = Object.assign(
          this.defaultColumnDefinition,
          this.options("spreadsheetColumnDefinition"),
        )),
        (this.columnDefs = []),
        (this.rowDefs = []),
        (this.columnFields = []),
    ...
    getData(e) {
      ...
      return (
        ...
        e ||
          this.options("spreadsheetOutputFull") ||
          ((t = o.map((e) => e.findLastIndex((e) => void 0 !== e) + 1)),
          (i = Math.max(...t)),
  ...
  var Ye = Object.freeze({
    ...
    DataTreeModule: class extends M {
      ...
      initializeRow(e) {
        ...
        (!s &&
          ...
          e.modules.dataTree.branchEl.parentNode &&
          ...
          !s &&
            ...
            e.modules.dataTree.controlEl.parentNode &&
          ...
          (e.modules.dataTree = {
            ...
            branchEl:
              !(!e.modules.dataTree || !s) && e.modules.dataTree.branchEl,
          ...
          !1 !== s.children &&
            ...
            (o =
              ...
              this.table.options.dataTreeFilter
                ? this.table.modules.filter.filter(s.children)
                : s.children),
            this.table.modExists("sort") &&
              this.table.options.dataTreeSort &&
              this.table.modules.sort.sort(o, i),
            o.forEach((e) => {
              (n.push(e),
                this.getChildren(e, !1, !0).forEach((e) => {
                  n.push(e);
    ...
    FrozenColumnsModule: class extends M {
          ...
          if (
            ...
            (t.includes(n) || (this.layoutElement(n, s), t.push(n)),
              n.classList.toggle(
                ...
                s.modules.frozen.edge && "left" === s.modules.frozen.position,
              ),
              n.classList.toggle(
                "tabulator-frozen-right",
                s.modules.frozen.edge && "right" === s.modules.frozen.position,
              ));
      ...
      layoutElement(e, t) {
        ...
        t.modules.frozen &&
          ...
          e.classList.toggle(
            "tabulator-frozen-left",
            t.modules.frozen.edge && "left" === t.modules.frozen.position,
          ),
          e.classList.toggle(
            "tabulator-frozen-right",
            t.modules.frozen.edge && "right" === t.modules.frozen.position,
          ));
      }
      adjustForScrollbar(e) {
        this.rightColumns.length &&
    ...
    GroupRowsModule: class extends M {
      ...
      virtualRenderFill() {
        const e = this.layoutMode();
        ("fitDataFill" !== e && "fitDataStretch" !== e && "fitColumns" !== e) ||
    ...
    InteractionModule: class extends M {
      ...
      clearTouchWatchers() {
        Object.values(this.touchWatchers).forEach((e) => {
          (clearTimeout(e.tapDbl), clearTimeout(e.tapHold));
      ...
      dispatchEvent(e, t, i) {
        ...
        (this.columnSubscribers[e] &&
          (i instanceof n
            ...
            : i instanceof r && (s = i.definition[e]),
          s && s(t, o)),
    ...
    MoveColumnsModule: class extends M {
      ...
      startMove(e, t) {
        ...
        (this.table.modules.selectRange &&
          this.table.modules.selectRange.columnSelection &&
          this.table.modules.selectRange.mousedown &&
          "column" === this.table.modules.selectRange.selecting) ||
          ((this.moving = t),
          (this.startX =
            ...
            value: function () {
              ...
              return (
                i.blocked ||
                  ...
                  (s = Array.prototype.push.apply(e, arguments)),
                  i.unblock("data-push")),
                s
              );
            },
            ...
            value: function () {
              ...
              return (
                i.blocked ||
                  ...
                  (s = Array.prototype.unshift.apply(e, arguments)),
              ...
              return (
                i.blocked ||
                  ...
                  i.data.length &&
                    ...
                    s.deleteActual(),
                  (o = Array.prototype.shift.call(e)),
            ...
            value: function () {
              ...
              if (!i.blocked && t === i.currentVersion) {
                ...
                ((l || 0 !== a) && i.table.rowManager.reRenderInPosition(),
                  (o = Array.prototype.splice.apply(e, arguments)),
          ...
          (Object.defineProperty(i, "push", {
            ...
            value: function () {
              ...
              return (
                t.blocked ||
                  (t.block("tree-push"),
                  (s = Array.prototype.push.apply(i, arguments)),
                  t.rebuildTree(e),
                  t.unblock("tree-push")),
                s
              );
            ...
            value: function () {
              ...
              return (
                t.blocked ||
                  ...
                  (s = Array.prototype.unshift.apply(i, arguments)),
                  t.rebuildTree(e),
          ...
          Object.defineProperty(i, "splice", {
            ...
            value: function () {
              ...
              return (
                t.blocked ||
                  (t.block("tree-splice"),
                  (s = Array.prototype.splice.apply(i, arguments)),
                  t.rebuildTree(e),
    ...
    ResizeColumnsModule: class extends M {
      ...
      getResizingClientX(e) {
        if (void 0 !== e.clientX) return e.clientX;
        const t = this.table.options.resizableColumnGuide
          ? e.changedTouches?.[0]
          : e.touches?.[0];
        return t?.clientX;
      }
      resize(e, t) {
        var i = this.getResizingClientX(e);
        if ("number" == typeof i && isFinite(i)) {
          ...
          if (
            ...
            this.table.options.resizableColumnFit &&
              this.nextColumn &&
              (!s || !o))
          ) {
            let e = this.nextColumn.getWidth();
            (r > 0 &&
              e <= this.nextColumn.minWidth &&
              (this.nextColumn = this.nextColumn.nextColumn()),
              this.nextColumn &&
                this.nextColumn.setWidth(this.nextColumn.getWidth() - r));
          }
          (this.table.columnManager.rerenderColumns(!0),
            !this.table.browserSlow &&
              t.modules.resize &&
              t.modules.resize.variableHeight &&
              t.checkCellHeights());
        } else
          console.warn(
            "ResizeColumns: could not resolve pointer X from event",
            e,
          );
      }
      calcGuidePosition(e, t, i) {
        var s = void 0 === e.clientX ? e.touches[0].clientX : e.clientX,
          o =
            ...
            this.table.element.getBoundingClientRect().x,
        ...
        function r(e) {
          (o.table.options.resizableColumnGuide && (o.resize(e, t), s.remove()),
            ...
            o.startWidth !== t.getWidth() &&
              (o.table.columnManager.verticalAlignHeaders(),
      ...
      calcGuidePosition(e, t, i) {
        var s = void 0 === e.screenY ? e.touches[0].screenY : e.screenY,
          o =
            ...
            this.table.element.getBoundingClientRect().y,
    ...
    ResizeTableModule: class extends M {
              ...
              ? (this.initializeVisibilityObserver(),
                ...
                (this.resizeObserver = new ResizeObserver((e) => {
                  if (
                    ...
                    (t.browserMobile &&
                      (!t.modules.edit ||
                        (t.modules.edit && !t.modules.edit.currentCell)))
                  ) {
      ...
      initializeVisibilityObserver() {
        ((this.visibilityObserver = new IntersectionObserver((e) => {
          ((this.visible = e[e.length - 1].isIntersecting),
            this.initialized
              ? this.visible &&
    ...
    SelectRangeModule: class extends M {
      ...
      constructor(e) {
        (super(e),
          ...
          this.registerTableOption("selectableRangeInitializeDefault", !0),
          this.registerTableOption("selectableRangeBlurEditOnNavigate", void 0),
          this.registerTableFunction(
            "getRangesData",
            this.getRangesData.bind(this),
          ),
          this.registerTableFunction("getRanges", this.getRanges.bind(this)),
          this.registerTableFunction(
            "addRange",
            this.addRangeFromComponent.bind(this),
          ),
          this.registerComponentFunction(
            "cell",
            "getRanges",
            this.cellGetRanges.bind(this),
          ),
          this.registerComponentFunction(
            "row",
            "getRanges",
            this.rowGetRanges.bind(this),
          ),
          this.registerComponentFunction(
            "column",
            "getRanges",
            this.colGetRanges.bind(this),
          ));
      }
      initialize() {
        (this.options("selectableRange") &&
          (this.options("selectableRows")
            ? console.warn(
                "SelectRange functionality cannot be used in conjunction with row selection",
              )
            : ((this.maxRanges = this.options("selectableRange")),
              this.initializeTable(),
              this.initializeWatchers()),
          this.options("columns").findIndex((e) => e.frozen) > 0 &&
            console.warn(
              "Having frozen column in arbitrary position with selectRange option may result in unpredictable behavior.",
            ),
          this.options("columns").filter((e) => e.frozen) > 1 &&
            console.warn(
              "Having multiple frozen columns with selectRange option may result in unpredictable behavior.",
            )),
          this.subscribe("edit-nav-disabled", () => !0));
      }
      initializeTable() {
        ((this.overlay = document.createElement("div")),
          ...
          this.activeRangeCellElement.classList.add(
      ...
      initializeWatchers() {
        ((this.columnSelection = this.options("selectableRangeColumns")),
          ...
          this.subscribe(
            "edit-editor-clear",
            this.finishEditingCell.bind(this),
          ),
          this.subscribe("edit-blur", this.restoreFocus.bind(this)),
          this.subscribe(
            "keybinding-nav-prev",
            this.keyNavigate.bind(this, "prev"),
          ),
          this.subscribe(
            "keybinding-nav-next",
            this.keyNavigate.bind(this, "next"),
          ),
          this.subscribe(
            "keybinding-nav-left",
            this.keyNavigate.bind(this, "left"),
          ),
          this.subscribe(
            "keybinding-nav-right",
            this.keyNavigate.bind(this, "right"),
          ),
          this.subscribe(
            "keybinding-nav-up",
            this.keyNavigate.bind(this, "up"),
          ),
          this.subscribe(
            "keybinding-nav-down",
            this.keyNavigate.bind(this, "down"),
          ),
          this.subscribe(
            "keybinding-nav-range",
            this.keyNavigateRange.bind(this),
          ));
      }
      initializeColumn(e) {
        this.columnSelection &&
          e.definition.headerSort &&
          "icon" !== this.options("headerSortClickElement") &&
          console.warn(
      ...
      updateHeaderColumn() {
        ...
        (this.rowSelection &&
          ((this.rowHeader =
            this.table.columnManager.getVisibleColumnsByIndex()[0]),
          this.rowHeader &&
            ((this.rowHeader.definition.cssClass =
              this.rowHeader.definition.cssClass +
              " tabulator-range-row-header"),
            this.rowHeader.definition.headerSort &&
              console.warn(
                "Using column headerSort with selectableRangeRows option may result in unpredictable behavior",
              ),
            this.rowHeader.definition.editor &&
              console.warn(
                "Using column editor with selectableRangeRows option may result in unpredictable behavior",
              ))),
          this.table.modules.frozenColumns &&
            this.table.modules.frozenColumns.active &&
            ((e = this.table.modules.frozenColumns.getFrozenColumns()).length >
              1 ||
              (1 === e.length && e[0] !== this.rowHeader)) &&
            console.warn(
      ...
      cellGetRanges(e) {
        ...
        return (
          (t =
            e.column === this.rowHeader
              ? this.ranges.filter((t) => t.occupiesRow(e.row))
              : this.ranges.filter((t) => t.occupies(e))),
      ...
      _handleKeyDown(e) {
        if (
          !this.blockKeydown &&
          (!this.table.modules.edit ||
            (this.table.modules.edit && !this.table.modules.edit.currentCell))
        ) {
          if ("Enter" === e.key) {
            if (this.table.modules.edit && this.table.modules.edit.currentCell)
              return;
            var t = this.getActiveCell();
            if (t) return;
            (this.table.modules.edit.editCell(t), e.preventDefault());
          }
          ("Backspace" !== e.key && "Delete" !== e.key) ||
            !this.options("selectableRangeClearCells") ||
            (this.activeRange && this.activeRange.clearValues());
        }
      }
      initializeFocus(e) {
        var t;
        ...
        try {
          document.selection
            ? ((t = document.body.createTextRange()).moveToElementText(
              ...
              t.select())
            : window.getSelection &&
              ((t = document.createRange()).selectNode(e.getElement()),
              window.getSelection().removeAllRanges(),
      ...
      handleColumnMouseDown(e, t) {
        (2 !== e.button ||
          ("column" !== this.selecting && "all" !== this.selecting) ||
          !this.activeRange.occupiesColumn(t)) &&
          ((this.table.options.movableColumns &&
      ...
      handleColumnMouseMove(e, t) {
        t !== this.rowHeader &&
          this.mousedown &&
          "all" !== this.selecting &&
          this.activeRange.setBounds(!1, t, !0);
      }
      renderCell(e) {
        var t = e.getElement(),
        ...
        (t.classList.toggle("tabulator-range-selected", -1 !== i),
          t.classList.toggle(
            ...
            1 === this.ranges.length &&
              this.ranges[0].atTopLeft(e) &&
              this.ranges[0].atBottomRight(e),
          ),
          (t.dataset.range = i));
      }
      handleCellMouseDown(e, t) {
        (2 === e.button &&
          (this.activeRange.occupies(t) ||
            (("row" === this.selecting || "all" === this.selecting) &&
              this.activeRange.occupiesRow(t.row)))) ||
          ((this.mousedown = !0),
          document.addEventListener("mouseup", this.mouseUpEvent),
          this.newSelection(e, t));
      }
      ...
      keyNavigate(e, t) {
        if (this.options("selectableRangeBlurEditOnNavigate")) {
          if (this.chain("edit-check-editing")) {
            if ("next" !== e && "prev" !== e) return !1;
            this.dispatch("edit-cancel-cell");
          }
        }
        ("prev" === e ? (e = "left") : "next" === e && (e = "right"),
      ...
      navigate(e, t, i) {
        ...
        if (
          (this.ranges.length > 1 &&
            (this.ranges = this.ranges.filter((e) =>
              e === this.activeRange
                ? (e.setEnd(e.start.row, e.start.col), !0)
                : (e.destroy(), !1),
            )),
          (n = {
          ...
          if (
            t &&
            (("row" === this.selecting && ("left" === i || "right" === i)) ||
              ("column" === this.selecting && ("up" === i || "down" === i)))
          )
            return;
          switch (i) {
            case "left":
        ...
        return (
          ...
          (n.top !== s.top ||
            ...
            (d.top >= c.top && d.bottom <= c.bottom) ||
              (l.getElement().parentNode && h.getElement().parentNode
                ? this.autoScroll(s, l.getElement(), h.getElement())
                : l.getComponent().scrollTo(void 0, !1)),
            (u.left >= m.left + this.getRowHeaderWidth() &&
              u.right <= m.right) ||
              (l.getElement().parentNode && h.getElement().parentNode
                ? this.autoScroll(s, l.getElement(), h.getElement())
                : h.getComponent().scrollTo(void 0, !1)),
            this.layoutElement()),
          !0
        );
      }
        ...
        if ("column" === t.type) {
          ...
          if (t === this.rowHeader) {
            ...
            var s,
              o = this.getCell(-1, -1);
            return (
              (s = this.rowHeader ? this.getCell(0, 1) : this.getCell(0, 0)),
              void i.setBounds(s, o)
            );
          }
          this.selecting = "column";
        } else
          t.column === this.rowHeader
            ? (this.selecting = "row")
            : (this.selecting = "cell");
        e.shiftKey
          ? this.activeRange.setBounds(!1, t, !0)
          : e.ctrlKey
            ? this.addRange().setBounds(t, void 0, !0)
            : this.resetRanges().setBounds(t, void 0, !0);
      }
      autoScroll(e, t, i) {
        var s,
          o,
        ...
        (void 0 === t && (t = this.getRowByRangePos(e.end.row).getElement()),
          void 0 === i &&
            (i = this.getColumnByRangePos(e.end.col).getElement()),
          (s = {
            left: i.offsetLeft,
          ...
          (o.left < s.left &&
            ...
            s.right < o.right) ||
            (s.left < o.left
              ? (r.scrollLeft = s.left - this.getRowHeaderWidth())
              : s.right > o.right &&
                (r.scrollLeft = Math.min(
                  s.right - r.clientWidth,
                  s.left - this.getRowHeaderWidth(),
                ))),
          n ||
            (s.top < o.top
              ? (r.scrollTop = s.top)
              : s.bottom > o.bottom &&
                (r.scrollTop = s.bottom - r.clientHeight)));
      }
      layoutChange() {
        ((this.overlay.style.visibility = "hidden"),
          clearTimeout(this.layoutChangeTimeout),
          (this.layoutChangeTimeout = setTimeout(
            this.layoutRanges.bind(this),
            200,
          )));
      }
      redraw(e) {
      ...
      layoutElement(e) {
        ((e
          ? this.table.rowManager.getVisibleRows(!0)
          : this.table.rowManager.getRows()
        ).forEach((e) => {
          "row" === e.type &&
            (this.layoutRow(e), e.cells.forEach((e) => this.renderCell(e)));
        }),
        ...
        this.table.initialized &&
          ...
          this.table.rtl
            ? (this.activeRangeCellElement.style.right =
                i.offsetWidth - t.offsetLeft - t.offsetWidth + "px")
            : (this.activeRangeCellElement.style.left =
                i.offsetLeft + t.offsetLeft + "px"),
      ...
      getCell(e, t) {
        var i;
        return t < 0 && (t = this.getTableColumns().length + t) < 0
          ? null
          : (e < 0 && (e = this.getTableRows().length + e),
            (i = this.table.rowManager.getRowFromPosition(e + 1))
              ? i.getCells(!1, !0).filter((e) => e.column.visible)[t]
              : null);
      }
      getActiveCell() {
        if (this.activeRange)
          return this.getCell(
            this.activeRange.start.row,
            this.activeRange.start.col,
          );
      }
      getRowByRangePos(e) {
      ...
      addRange(e, t) {
        ...
        return (
          !0 !== this.maxRanges &&
            this.ranges.length >= this.maxRanges &&
            this.ranges.shift().destroy(),
          (i = new Ne(this.table, this, e, t)),
          (this.activeRange = i),
          this.ranges.push(i),
      ...
      createDefaultRange() {
        ...
        return (
          (e = this.addRange()),
          this.table.rowManager.activeRows.length &&
            ((i = this.table.rowManager.activeRows[0].cells.filter(
              (e) => e.column.visible,
            )),
            (t = i[this.rowHeader ? 1 : 0]) &&
              (e.setBounds(t),
              this.options("selectableRangeAutoFocus") &&
                this.initializeFocus(t))),
          e
        );
      }
      clearRanges() {
        (this.ranges.forEach((e) => e.destroy()), (this.ranges = []));
      }
      setDefaultRange() {
        (this.clearRanges(),
          this.options("selectableRangeInitializeDefault") &&
            this.createDefaultRange());
      }
      resetRanges() {
        return (this.clearRanges(), this.createDefaultRange());
      }
      tableDestroyed() {
        (document.removeEventListener("mouseup", this.mouseUpEvent),
          this.table.rowManager.element.removeEventListener(
      ...
      selectedRows(e) {
        return e
          ? this.activeRange.getRows().map((e) => e.getComponent())
          : this.activeRange.getRows();
      }
      selectedColumns(e) {
        return e
          ? this.activeRange.getColumns().map((e) => e.getComponent())
    ...
    SelectRowModule: class extends M {
      ...
      initialize() {
        (this.deprecatedOptionsCheck(),
          "highlight" === this.table.options.selectableRows &&
            this.table.options.selectableRange &&
            (this.table.options.selectableRows = !1),
          !1 !== this.table.options.selectableRows &&
            ...
            this.table.options.selectableRows &&
              !this.table.options.selectableRowsPersistence &&
          ...
          (t.ctrlKey || t.metaKey
            ? (r.forEach((t) => {
                t !== this.lastClickedRow &&
                  (!0 === this.table.options.selectableRows ||
            ...
            : (this.deselectRows(void 0, !0),
              !0 !== this.table.options.selectableRows &&
                r.length > this.table.options.selectableRows &&
                (r = r.slice(0, this.table.options.selectableRows)),
              this.selectRows(r)),
            this.table._clearSelection());
        } else
          t.ctrlKey || t.metaKey
            ...
            : (this.deselectRows(void 0, !0),
              (1 === this.selectedRows.length && this.isRowSelected(e)) ||
                this.selectRows(e),
              (this.lastClickedRow = e));
      }
      checkRowSelectability(e) {
        return (
          !(!e || "row" !== e.type) &&
          this.table.options.selectableRowsCheck.call(
            this.table,
            e.getComponent(),
          )
        );
      ...
      _selectRow(e, t, i) {
        if (
          !isNaN(this.table.options.selectableRows) &&
          !0 !== this.table.options.selectableRows &&
          !i &&
          this.selectedRows.length >= this.table.options.selectableRows
        ) {
    ...
    SpreadsheetModule: class extends M {
      ...
      constructor(e) {
        (super(e),
          ...
          this.registerTableFunction(
            "getSheetDefinitions",
            this.getSheetDefinitions.bind(this),
          ),
          this.registerTableFunction(
            "setSheetData",
            this.setSheetData.bind(this),
          ),
          this.registerTableFunction("getSheet", this.getSheet.bind(this)),
          this.registerTableFunction(
            "getSheetData",
            this.getSheetData.bind(this),
          ),
          this.registerTableFunction("clearSheet", this.clearSheet.bind(this)),
          this.registerTableFunction(
            "removeSheet",
            this.removeSheetFunc.bind(this),
          ),
          this.registerTableFunction(
            "activeSheet",
            this.activeSheetFunc.bind(this),
          ));
      }
      initialize() {
      ...
      compatibilityCheck() {
        (this.options("data") &&
          ...
          this.options("responsiveCollapse") &&
            console.warn(
      ...
      loadSheet(e) {
        this.activeSheet !== e &&
          (this.activeSheet && this.activeSheet.unload(),
          (this.activeSheet = e),
          e.load());
      }
      newSheet(e = {}) {
        var t;
        return (
          e.rows || (e.rows = this.options("spreadsheetRows")),
      ...
      removeSheet(e) {
        ...
        this.sheets.length > 1
          ? i > -1 &&
            ...
            e.destroy(),
            this.activeSheet === e &&
              ((t = this.sheets[i - 1] || this.sheets[0])
                ? this.loadSheet(t)
                : (this.activeSheet = null)))
          : console.warn(
              "Unable to remove sheet, at least one sheet must be active",
            );
      }
      lookupSheet(e) {
        return e
  ...
  return class extends _ {
    static extendModule() {
      (_.initializeModuleBinder(Ye), _._extendModule(...arguments));
    }
    static registerModule() {
      (_.initializeModuleBinder(Ye), _._registerModule(...arguments));
    }
    constructor(e, t, i) {
      super(e, t, Ye);
    }
